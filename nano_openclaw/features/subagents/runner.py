...
from nano_openclaw.features.subagents.registry import SubagentRegistry, get_registry
...
class SubagentRunner:
    ...
    async def _run_subagent(
        ...
        from nano_openclaw.features.subagents.announce import build_announce_message, should_announce
