...
xiaozhi: {
  ...
  ttsPrebufferMs: 2400,    // 本地 TTS 目标预缓冲时长；0 禁用
  ttsPrebufferMaxWaitMs: 1800, // 首个 PCM 包后最多等待多久，短回复完成后不等待
}
```
